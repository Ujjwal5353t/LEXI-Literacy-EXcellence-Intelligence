      ...
      <article className="stat-card stat-card-hover p-6 sm:p-12 border border-white/80 shadow-lg space-y-8" style={{ borderLeftColor: 'var(--color-primary)' }}>
        ...
        <header className="border-b border-surface-container-highest pb-6">
          <div className="flex items-center gap-3 mb-4">
            ...
            <div>
              ...
              <h1 className="font-display text-3xl sm:text-4xl font-extrabold text-primary">Lexi Privacy Policy</h1>
        ...
        <section className="stat-card stat-card-hover p-5 rounded-2xl border border-amber-500/30 bg-amber-500/10 text-on-surface" style={{ borderLeftColor: 'var(--risk-medium-border)' }}>
          ...
          <p className="font-body text-xs sm:text-sm text-on-surface-variant leading-relaxed student-text">
            Lexi is an educational screening and practice tool. It does <strong>not</strong> provide a clinical or medical diagnosis of dyslexia or any other neurological, developmental, or medical condition. For formal diagnostic assessment, consult a qualified speech-language pathologist, educational psychologist, or medical specialist.
          </p>
        </section>
        ...
        <section className="space-y-3">
          ...
          <p className="font-body text-sm sm:text-base leading-relaxed text-on-surface-variant student-text">
            Under the Digital Personal Data Protection Act, 2023 ("DPDP Act"), Lexi acts as the <strong>Data Fiduciary</strong> responsible for determining the purpose and means of processing personal data.
          </p>
          <div className="stat-card stat-card-hover p-4 rounded-2xl border border-surface-container-high text-xs sm:text-sm space-y-1 font-body" style={{ background: 'var(--color-muted)', borderLeftColor: 'var(--color-secondary)' }}>
            ...
            <p><strong>Division:</strong> Lexi Legal & Privacy Division</p>
            <p><strong>Email:</strong> <a href="mailto:privacy@lexi.com" className="text-primary font-bold hover:underline">privacy@lexi.com</a> / <a href="mailto:grievance@lexi.com" className="text-primary font-bold hover:underline">grievance@lexi.com</a></p>
        ...
        <section className="space-y-3">
          ...
          <p className="font-body text-sm sm:text-base leading-relaxed text-on-surface-variant student-text">
            In compliance with Section 2(f) of the DPDP Act, 2023, any individual who has not completed 18 years of age is defined as a child. Lexi is designed for primary and middle school students (ages 6–14):
          </p>
          <ul className="list-disc pl-5 font-body text-xs sm:text-sm text-on-surface-variant space-y-2 leading-relaxed student-text">
            ...
            <li><strong>Prohibition of Behavioral Tracking & Ads:</strong> In strict compliance with Section 9(2) of the DPDP Act, Lexi does <em>not</em> conduct behavioral tracking, serve targeted ads to children, or sell student data.</li>
        ...
        <section className="space-y-3">
          ...
          <p className="font-body text-sm sm:text-base leading-relaxed text-on-surface-variant student-text">
            Lexi relies on trusted infrastructure sub-processors. In compliance with Section 16 of the DPDP Act, cross-border data transfer outside India is permitted subject to technical safeguards and parental notice:
          </p>
        ...
        <section className="space-y-3">
          ...
          <p className="font-body text-xs sm:text-sm text-on-surface-variant student-text">
            To exercise any data rights, please contact our Grievance Officer at <a href="mailto:privacy@lexi.com" className="text-primary font-bold hover:underline">privacy@lexi.com</a>.
          </p>
        </section>
      </article>
    </main>
